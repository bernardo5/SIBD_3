...
\begin{enumerate}
  \item Conversão de entidades fortes e suas especializações (quando aplicável):
  		...
  		\textit{Time\_period (\underline{Start}, \underline{End}, Internet\_domain\_name, Digit\_code, Serial\_number, National\_Health\_Service\_number1, National\_Health\_Service\_number2)}
