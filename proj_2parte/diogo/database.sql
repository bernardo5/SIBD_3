...
insert into Period values ('2013-11-25', '2013-12-01');
insert into Period values ('2011-10-10', '2012-10-10');
insert into Period values ('2013-10-26', '2013-11-26');
insert into Period values ('2014-10-26', '2014-11-26');
insert into Period values ('2015-10-26', '2015-11-26');
insert into Period values ('2015-12-10', '2016-01-01');

/*insert into Connects values ('2015-04-01', '2015-10-25', 123456789, 'RPG', 'www.pan1.pt');*/
/*insert into Connects values ('2011-10-10', '2012-10-10', 123456789, 'Philips', 'www.pan1.pt');
insert into Connects values ('2013-10-26', '2013-11-26', 123456789, 'LG', 'www.pan1.pt');
insert into Connects values ('2014-10-26', '2014-11-26', 123456790, 'Philips', 'www.pan1.pt');
insert into Connects values ('2015-10-26', '2015-11-26', 123456789, 'Philips', 'www.pan1.pt');
insert into Connects values ('2015-12-10', '2016-01-01', 123456789, 'Philips', 'www.pan3.pt');*/
...
insert into Connects values ('2013-11-25', '2013-12-01', 123456789, 'Philips', 'www.pan3.pt');
...
insert into Wears values ('2013-11-25', '2013-12-01', '001-54245-1555575', 'www.pan1.pt');
